...
sleep 0.2
echo "- Tritium项目讨论可到955219205该群讨论"
sleep 0.2

rm -rf /data/powercfg.json
rm -rf /data/powercfg.sh

echo "- 正在安装CuJankDetector模块"
sleep 0.4

chmod 777 $MODPATH/modules/cu_jank_detector.zip
magisk --install-module $MODPATH/modules/cu_jank_detector.zip

chmod 777 $MODPATH/powercfg/powercfg.json
chmod 777 $MODPATH/powercfg/powercfg.sh
...
if [ -e ${MODPATH}/configs/${config_name}.json ]; then
    ...
    rm -r /data/adb/modules/ct_module/modules
    rm -r /data/adb/modules/ct_module/powercfg
